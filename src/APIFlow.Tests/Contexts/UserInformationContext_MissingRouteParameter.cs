...
{
    public class UserInformationContext_MissingRouteParameter : ApiContext<UserInformation, HTTPDataExtender>
    {
        ...
        public UserInformationContext_MissingRouteParameter(UserInformation baseObject, APIFlowInputModel inputModel) : base(baseObject, inputModel)
        {
